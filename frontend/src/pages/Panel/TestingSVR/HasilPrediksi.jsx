...
const HasilPrediksi = ({ result }) => {
  ...
  useEffect(() => {
    if (result) {
      ...
      setdataHarga(result.Hasil_Prediksi)
    }
  }, [result]);
  ...
  const unduhExcel = () => {
      ...
      saveAs(data, "hasil_prediksi_data_harga_tomat.xlsx");
    };
  return (
          ...
          <Table className="border">
            <TableHeader className="bg-gradient-to-r from-[#f2e3c94b] to-[#ffffff00]">
              <TableRow>
                ...
                <TableHead className="text-center font-bold text-black">Prediksi</TableHead>
              </TableRow>
            </TableHeader>
              ...
              {currentData.length > 0 ? (
                currentData.map((item, index) => (
                  <TableRow key={index}>
                    ...
                    <TableCell className="text-center">{item.Harga_Prediksi}</TableCell>
                  </TableRow>
                ))
              ) : (
                <TableRow>
